$(function() {
  ...
  let tiny_forum = {
    plugins: 'autolink autosave fullscreen help lists preview visualchars wordcount',
    toolbar: 'fullscreen | undo redo | editing | aligning | styling | link unlink | fontfamily fontsize forecolor backcolor | numlist bullist',
    toolbar_groups: {
      aligning: {
        icon: 'align-center',
        tooltip: 'Alignment',
