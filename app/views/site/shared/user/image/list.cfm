    ...
    <div class='card'>
      ...
      <div class='card-body border-left border-right'>
        <cfif locals.view=='list'>
          <a href='#router.href('user/image/edit')#' class='btn btn-nmg btn-sm btn-outline-dark mt-1'>
          ...
          <cfloop array='#locals.mImages#' item='locals.mImage' index='idx'>
            <div class='row'>
              <div class='row p-2 my-2 border'>
                <div class='col-3'>
                  <a href='#router.hrefenc(page: 'user/image/edit', uiid: locals.mImage.uiid())#'>
        ...
        <cfelse>
          <div class='row'>
            <div class='col-2 text-center small'>
              <a href='#router.href('user/image/edit')#'>
                <img src='/assets/images/image_new.png' class='w-100 img-thumbnail' />
              </a>
              <a href='#router.href('user/image/edit')#' class='w-100 btn btn-nmg btn-sm btn-outline-dark mt-1'>
                <i class='fal fa-plus'></i> Add Image
              </a>
            </div>
            <cfloop array='#locals.mImages#' item='locals.mImage' index='idx'>
              <div class='col-2 text-center' title='#locals.mImage.dimensions()# &bull; #locals.mImage.size_mb()#'>
                ...
                <a href='#router.hrefenc(page: 'user/image/edit', uiid: locals.mImage.uiid())#' class='w-100 btn btn-nmg btn-sm btn-outline-dark mt-1'>
                  <i class='fal fa-pencil'></i> #locals.mImage.filename()#
                </a>
              </div>
            </cfloop>
