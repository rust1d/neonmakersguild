            ...
            <div class='row g-3'>
              <div class='col-md-8 col-lg-9'>
                <div class='row g-3'>
                  ...
                  <div class='col-12'>
                    <label class='form-label' for='bpa_alias'>Alias</label> <small class='text-muted ps-3'>auto-generated from title if left blank</small>
              ...
              <div class='col-md-4 col-lg-3'>
                <div class='row g-3'>
                  <div class='col-12'>
                    ...
                    <select class='form-control form-control-sm mt-1' name='bpa_categories' id='bpa_categories' multiple='multiple' size='5'>
              ...
              <div class='col-12'>
                ...
                <textarea class='tiny-mce form-control' rows='15' name='bpa_body' id='bpa_body'>#htmlEditFormat(mPage.body())#</textarea>
              </div>
            </div>
            <div class='row mt-5'>
