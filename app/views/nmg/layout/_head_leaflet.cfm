<cfoutput>
  <cfsavecontent variable='locals.head'>
    ...
    <script src='https://cdnjs.cloudflare.com/ajax/libs/leaflet.fullscreen/4.0.0/Control.FullScreen.min.js' crossorigin='anonymous' referrerpolicy='no-referrer'></script>
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/leaflet.fullscreen/4.0.0/Control.FullScreen.min.css' crossorigin='anonymous' referrerpolicy='no-referrer' />
  </cfsavecontent>
</cfoutput>
