        ...
        <ul class='navbar-nav flex-grow-1 justify-content-evenly'>
          ...
          <li class='nav-item dropdown drop-right'>
            ...
            <div class='dropdown-menu nav-dropdown mt-1 py-3 px-1'>
              <a class='dropdown-item round-icon' href='/calendar'><i class='fa-solid fa-calendar'></i> Events Calendar</a>
          ...
          <cfif session.user.loggedIn()>
            <li class='nav-item d-none d-lg-inline'><a class='nav-link' href='#session.user.seo_link()#'>My Page</a></li>
          </cfif>
        </ul>
        <ul class='navbar-nav'>
          <cfif session.user.loggedIn()>
