    ...
    <div class='row mb-3'>
      <div class='col-auto'>
        <div class='position-relative'>
          ...
          <button type='button' data-bs-target='##profile_modal' data-bs-toggle='modal' class='profile-upload-btn btn btn-nmg btn-sm btn-outline-dark btn-floating fal fa-camera'></button>
        </div>
      </div>
    </div>
  <cfelse>
    <div class='row mb-3'>
      <div class='col-12'>
        <button type='button' data-bs-target='##profile_modal' data-bs-toggle='modal' class='position-relative profile-upload-btn btn btn-nmg btn-sm btn-outline-dark btn-floating fal fa-camera'></button>
