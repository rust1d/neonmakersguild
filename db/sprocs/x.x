...
BEGIN
  ...
  INSERT INTO blogentries (
    ben_blog, ben_usid, ben_title, ben_body, ben_posted, ben_morebody, ben_alias, ben_allowcomments, ben_image, ben_filesize, ben_mimetype, ben_views, ben_released, ben_mailed
  ) VALUES (
    _blog, _usid, _title, _body, _posted, _morebody, _alias, _allowcomments, _image, _filesize, _mimetype, _views, _released, _mailed
  );
