...
UPDATE blogtextblocks SET btb_body = '<div class=\"card\">\r\n<div class=\"card-body\">\r\n<div class=\"row justify-content-center\">\r\n<div class=\"col-12 text-center fs-3\">Welcome to the Neon Makers Guild!</div>\r\n<div class=\"col-4 text-center\"><img class=\"img-fluid p-3\" src=\"/assets/images/user/1/A0A080F42E6F13B3A2DF133F073095DD.jpg\" alt=\"neon-makers-guild-logo - 1200 x 1200\"></div>\r\n<div class=\"col-12\">This is a place for neon makers at any stage in their neon journey to find resources, ask questions, share stories and connect with their peers. Our website is viewable to all who visit, but joining the guild provides you with access and features exclusive to being a member. Click <a class=\"text-red\" style=\"color: #e03e2d;\" href=\"/join\" target=\"_blank\" rel=\"noopener\">here to join</a> the Neon Maker&rsquo;s Guild.</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"centered-logo-line\">&bull;<img src=\"https://neonmg.s3.amazonaws.com/assets/images/logo-256.png\" height=\"32\">&bull;</div>' WHERE btb_btbid = 8;
UPDATE blogtextblocks SET btb_body = '<div class=\"content-card\">\r\n<div class=\"text-center\" style=\"font-size: 18pt; font-family: \'courier new\', courier;\">THE WALL OF NEON</div>\r\n<div class=\"text-center\" style=\"font-family: montserrat; font-size: 10pt;\">Recent posts by members of the Neon Makers Guild</div>\r\n</div>' WHERE btb_btbid = 9;
