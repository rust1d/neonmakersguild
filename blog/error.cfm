...
<cfset blogConfig = SESSION.BROG.getProperties()>
...
<cfset udfEmail(to="#blogConfig.owneremail#", from="#blogConfig.owneremail#", type="html", subject="Error Report", body="#mail#") />
