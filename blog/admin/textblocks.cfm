...
<cfif structKeyExists(form, "mark")>
	<cfloop index="u" list="#form.mark#">
		<cfset APPLICATION.BLOG.textblock.deleteTextblock(u)>
	</cfloop>
</cfif>

<cfset tbs = APPLICATION.BLOG.textblock.getTextblocks()>
...
<cfmodule template="../tags/adminlayout.cfm" title="Textblocks">
	...
	<cfmodule template="../tags/datatable.cfm" data="#tbs#" editlink="x.textblock.cfm" label="Textblocks"
