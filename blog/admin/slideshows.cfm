...
<cfmodule template="../tags/adminlayout.cfm" title="Slideshows">
	...
	<cfmodule template="../tags/datatable.cfm" data="#slideshows#" editlink="x.slideshow.cfm" label="Slideshows"
		...
		<cfmodule template="../tags/datacol.cfm" label="View" data="<a href=""#APPLICATION.PATH.ROOT#/slideshow.cfm/$name$"">View</a>" sort="false"/>
	</cfmodule>
