...
<cfif structKeyExists(form, "save")>
  ...
  <cfif not arrayLen(errors)>
    <cfset application.blog.saveComment(url.id, left(form.name,50), left(form.email,50), left(form.bco_website,255), form.comment, form.subscribe, form.bco_moderated)>
    <cflocation url="comments.cfm" addtoken="false">
  </cfif>
...
<cfmodule template="../tags/adminlayout.cfm" title="Comment Editor">
  ...
  <table>
    ...
    <tr>
      <td align="right">bco_website:</td>
      <td><input type="text" name="bco_website" value="#form.bco_website#" class="txtField"></td>
    </tr>
    <tr valign="top">
    ...
    <tr>
      <td align="right">bco_moderated:</td>
      <td>
