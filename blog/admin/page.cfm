...
<cfif url.id is not 0>
  ...
  <cfif not structKeyExists(form, "save")>
    <cfset form.categories = valueList(page.categories.bca_bcaid)>
  <cfelse>
  ...
  <table>
    ...
    <tr valign="top">
      ...
      <cfloop query="categories">
        <option value="#bca_bcaid#" <cfif listFind(form.categories,bca_bcaid)>selected</cfif>>#bca_category#</option>
      </cfloop>
      </select></td>
    </tr>
    <tr>
