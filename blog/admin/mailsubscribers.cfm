...
<a href="#application.rooturl#/unsubscribe.cfm?email=#email#&bsu_token=#bsu_token#">#application.rooturl#/unsubscribe.cfm?email=#email#&bsu_token=#bsu_token#</a>
</p>
      </cfoutput>
      </cfsavecontent>
...
<cfmodule template="../tags/adminlayout.cfm" title="Subscribers">
  ...
  Your blog currently has
    ...
    #vSubscribers.recordcount# bsu_verified subscribers
  ...
  <cfif vSubscribers.recordCount is 0>
    ...
    <cfoutput>
    <p>
    Since you do not have any bsu_verified subscribers, you will not be able to send a message.
    </p>
    </cfoutput>
