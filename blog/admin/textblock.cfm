...
<cfif URL.id is not 0>
	<cftry>
	<cfset tb = APPLICATION.BLOG.textblock.getTextblock(id=URL.id)>
	<cfif structIsEmpty(tb)>
		<cflocation url="x.textblocks.cfm" addToken="false">
	</cfif>
	<cfcatch>
		<cflocation url="x.textblocks.cfm" addToken="false">
	</cfcatch>
...
<cfif structKeyExists(form, "save")>
	...
	<cfif not arrayLen(errors)>
		<cfset APPLICATION.BLOG.textblock.saveTextblock(URL.id, left(form.label,255), form.body)>
		<cflocation url="x.textblocks.cfm" addToken="false">
	</cfif>
...
<cfmodule template="../tags/adminlayout.cfm" title="Textblock Editor">
	...
	<cfoutput>
	<form action="x.textblock.cfm?id=#URL.id#" method="post">
	<table>
		<tr>
