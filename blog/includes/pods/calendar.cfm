...
<cfset offset = SESSION.BROG.getProperty("offset")>
<cfset now = dateAdd("h", offset, now())>
<cfparam name="month" default="#month(now)#">
<cfparam name="year" default="#year(now)#">

<cfmodule template="../../tags/scopecache.cfm" cachename="pod_calendar_#month#_#year#" scope="application" timeout="#APPLICATION.BLOG.timeout#">

<cfmodule template="../../tags/podlayout.cfm" title="#APPLICATION.BLOG.resourceBundle.getResource("calendar")#">

<cfscript>
	// no idea why this was so hard to conceive
	function getFirstWeekPAD(firstDOW) {
		var firstWeekPad=0;
		var weekStartsOn=APPLICATION.BLOG.localeutils.weekStarts();
		switch (weekStartsON) {
			case 1:
	...
	localizedDays=APPLICATION.BLOG.localeutils.getLocalizedDays();
	localizedMonth=APPLICATION.BLOG.localeutils.getLocalizedMonth(month);
	localizedYear=APPLICATION.BLOG.localeutils.getLocalizedYear(year);
	...
	dayList=SESSION.BROG.getActiveDays(year,month);
	dayCounter=1;
	rowCounter=1;
</cfscript>
...
<tr>
	...
	<cfif APPLICATION.BLOG.localeutils.isBIDI()>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year(nextmonth)#/#month(nextmonth)#" rel="nofollow">&lt;&lt;</a>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year#/#month#" rel="nofollow">#localizedMonth# #localizedYear#</a>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year(lastmonth)#/#month(lastmonth)#" rel="nofollow">&gt;&gt;</a>
	<cfelse>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year(lastmonth)#/#month(lastmonth)#" rel="nofollow">&lt;&lt;</a>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year#/#month#" rel="nofollow">#localizedMonth# #localizedYear#</a>
		<a href="#SESSION.BROG.getProperty("blogurl")#/#year(nextmonth)#/#month(nextmonth)#" rel="nofollow">&gt;&gt;</a>
...
<cfloop index="x" from="#firstWeekPAD+1#" to="7">
	<cfoutput><td <cfif month(now) eq month and dayCounter eq day(now) and year(now) eq year> class="calendarToday"</cfif>><cfif listFind(dayList,dayCounter)><a href="#SESSION.BROG.getProperty("blogurl")#/#year#/#month#/#dayCounter#" rel="nofollow">#dayCounter#</a><cfelse>#dayCounter#</cfif></td></cfoutput>
...
<cfloop index="x" from="#dayCounter#" to="#dim#">
	...
	<cfoutput>
		...
		<cfif listFind(dayList,x) or listFind(dayList, "0" & x)><a href="#SESSION.BROG.getProperty("blogurl")#/#year#/#month#/#x#" rel="nofollow">#x#</a><cfelse>#x#</cfif>
		</td>
	</cfoutput>
