...
<cfmodule template="../../tags/podlayout.cfm" title="Tags">
   ...
   <cfquery dbtype="query" name="tags">
      SELECT entrycount AS tagCount,bca_category as tag, bca_bcaid
      FROM
         cats
      WHERE entrycount >= 10
   </cfquery>
   ...
   <cfoutput>
      <cfloop query="tags">
         ...
         <a href="#application.blog.makeCategoryLink(tags.bca_bcaid)#"><span class="#class#">#lcase(tags.tag)#</span></a>
      </cfloop>
   </cfoutput>
