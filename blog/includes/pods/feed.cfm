...
<cfmodule template="../../tags/podlayout.cfm" title="#APPLICATION.BLOG.resourceBundle.getResource("latestfromcfbloggers")#">
...
<cfmodule template="../../tags/scopecache.cfm" scope="application" cachename="feed" timeout="#60*60#">
	...
	<cftry>
		...
		<cfcatch>
			<cfoutput>
				#APPLICATION.BLOG.resourceBundle.getResource("cfbloggersfeeddown")#
			</cfoutput>
		</cfcatch>
	</cftry>
