...
<cfmodule template="../../tags/podlayout.cfm" title="#application.resourceBundle.getResource("archivesbysubject")#">
  ...
  <cfloop query="cats">
    <cfoutput><a href="#application.blog.makeCategoryLink(bca_bcaid)#" title="#bca_category# RSS">#bca_category# (#entryCount#)</a> [<a href="#application.rootURL#/rss.cfm?mode=full&amp;mode2=cat&amp;catid=#bca_bcaid#" rel="noindex,nofollow">RSS</a>]<br /></cfoutput>
  </cfloop>
